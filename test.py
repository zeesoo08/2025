...
st.markdown('<div class="subtitle">하루 3번 이상 양치한 습관, 치아 건강의 시작입니다!</div>', unsafe_allow_html=True)

# 두 번째 사진으로 변경
st.image("https://img.freepik.com/premium-vector/young-man-brushing-teeth-bathroom-oral-hygiene-care-dental-health_17140668.jpg", width=400, caption="오늘도 양치 잘했나요?")
...
if st.button("결과 확인"):
    if count >= 3:
        st.balloons()
        st.success(f"🎉 잘했어요! 오늘 {count}회 양치했네요! 꾸준한 습관이 치아 건강을 지켜줘요!")
